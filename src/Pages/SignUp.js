      ...
      <Form>
        <div className="row">
          <div className="col-md-6 text-center mb-4">
            <div className="p-4 border border-dark rounded" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
        ...
        <div className="text-center mt-3">
          <Button variant="primary" onClick={handleJoinClick} disabled={!selectedRole}>
            {selectedRole === 'client' ? 'Join as a Client' : 'Join as a Company'}
          </Button>
        </div>
      </Form>
